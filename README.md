...
[Craftgate](https://craftgate.io) is a payment hub on top of banks and other payment facilitators, allowing companies **to** process payments with lower costs and easy integration. Craftgate gives companies one-stop-shop payment services as a B2B SaaS product without interfering with the relationship between you and the bank. 
...
**We don't have a team leader position at Craftgate**. Every crafter is a natural-born leader and leads the team **naturally** regardless of years of experience. 
...
Here are some videos you should take a look **at** to learn more about us. **Note:** All videos are in Turkish.
...
We've been working remotely since March 2020. We love remote working and we plan to continue in that style forever. Crafters do not all live **in** Istanbul. We have teammates living in İstanbul, Ankara, Denizli, İzmir, Diyarbakır and Antalya already.
...
Regardless of age, years of experience, or previous job title, expectations are all the same for all crafters.

* Disciplined, motivated and passionate
* **Developing and designing code that fits project needs**
...
## Backend
* Java 17, Groovy 3, Kotlin 1.9.20, and the JVM ecosystem
...
* **Benchmarking**, prototyping, **data-centric** behavior analysis
...
If your submission is accepted after evaluating your CV, we organize a **Zoom** meeting as the first step in the process. Two crafters join from the Craftgate side and discuss technical topics for one hour. The discussions **are** mainly around the following areas and technology-stack-related topics.
...
When the project is submitted by the candidate, we evaluate **it**. If both sides **feel like continuing** with the process, we organize a challenge review meeting via **Zoom**.
